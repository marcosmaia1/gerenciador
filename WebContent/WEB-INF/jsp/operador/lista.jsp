	...
	<div class="grid">
		<h1>
			...
			<div class="tab-control" data-role="tab-control">
				<ul class="tabs">
					<li class="active"><a href="#_page_1">Listagem de operadores</a></li>
				</ul>
				<div class="frames">
					<div class="frame" id="_page_1">
						...
						<table id="tabelaOperador" class="table table-striped table bordered table-hover" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th>Opções</th>
									<th>Código</th>
							...
							<c:forEach var="entity" items="${operadorList}">
								<tr>
									<td>
										<div class="toolbar">
...
<script>
	$(document).ready(function() {
		montarTabelaOperador('${pageContext.request.contextPath}');
	});	
</script>